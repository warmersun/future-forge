 ...
 *
 * Regenerated: 2026-09-05T23:54:01.419Z
 * Source: fill-summaries filled=172 skipped=0
 * Themes: 43
  ...
  "rogue-si": [
    {
      ...
      summary: "Rogue SuperIntelligence. This is about AI making high-stakes decisions, and how we know the answer is right — and that it hasn’t gone rogue.",
      scene:
    ...
    },
    {
      ...
      summary: "Rogue SuperIntelligence. Emergency calls get sorted by a model that punishes slow, uncertain speech. The local job is still hearing the people the data never loved. The global job is keeping high-stakes routing from going rogue.",
      scene:
    ...
    },
    {
      ...
      summary: "Rogue SuperIntelligence. Water cuts get decided by an optimizer that treats small farms as rounding errors. Deal with the unfair cut here, and invent something that keeps the system from locking people out.",
      scene:
    ...
    },
    {
      ...
      summary: "Rogue SuperIntelligence. Night buses skip the stops that don’t look profitable. Keep the people who work after dark from being stranded, without letting the scheduler quietly go rogue.",
      scene:
  ...
  genocide: [
    {
      ...
      summary: "Prevent Genocide. Hospital records can become a shopping list for people who make families disappear. Keep care records useful without turning identity into a weapon.",
      scene:
    ...
    },
    {
      ...
      summary: "Prevent Genocide. Food aid can starve a block when the list is captured by local power. Feed people without turning rations into a clan weapon.",
      scene:
    ...
    },
    {
      ...
      summary: "Prevent Genocide. Relief tablets that only work in one language leave whole groups invisible. Make help reachable without a language that marks who lives.",
      scene:
    ...
    },
    {
      ...
      summary: "Prevent Genocide. Worker badges that never come back are how people vanish in plain sight. Track the missing without building a better hunt.",
      scene:
  ...
  poverty: [
    {
      ...
      summary: "Extreme Poverty. Piece-rate apps own the workers’ tips and hours. The local problem is getting paid for the work. The global problem is inventing income that isn’t a trap.",
      scene:
    ...
    },
    {
      ...
      summary: "Extreme Poverty. Advance pay chains people to a kiln they can’t leave. Break the debt loop without cutting the only wage in town.",
      scene:
    ...
    },
    {
      ...
      summary: "Extreme Poverty. School fees die when the cell mast fails. Keep kids in class when the connection — and the cash — drop out.",
      scene:
    ...
    },
    {
      ...
      summary: "Extreme Poverty. Dawn fares strand night cleaners after the last boat. Make the commute survivable without pricing the poor out of the city.",
      scene:
  ...
  "chem-bio": [
    {
      ...
      summary: "Chemical and Biological Weapons. Dye chemicals get a second use nobody admitted. Catch the dual-use before it leaves the row, without shutting honest work.",
      scene:
    ...
    },
    {
      ...
      summary: "Chemical and Biological Weapons. Lab kits travel under the wrong code. Keep real science moving without letting a kit become a weapon.",
      scene:
    ...
    },
    {
      ...
      summary: "Chemical and Biological Weapons. An outfall never names what it dumps. Detect the unnamed agent and stop it at the source.",
      scene:
    ...
    },
    {
      ...
      summary: "Chemical and Biological Weapons. Loaner strains walk out after closing time. Keep research samples from becoming someone else’s weapon.",
      scene:
  ...
  asteroid: [
    {
      ...
      summary: "Asteroid Impact. Mine glare blanks the sky watch that is supposed to see the rock. Keep the watch honest, and actually move the needle on planetary defense.",
      scene:
    ...
    },
    {
      ...
      summary: "Asteroid Impact. Telescope dishes sit in a backlog while the clock runs. Get a clean track out in time to matter.",
      scene:
    ...
    },
    {
      ...
      summary: "Asteroid Impact. Time on the big instruments freezes after every scare. Share the sky so a real rock isn’t missed in the panic.",
      scene:
    ...
    },
    {
      ...
      summary: "Asteroid Impact. The kinetic stack waits while the test range idles. Practice the deflection before the one shot that counts.",
      scene:
  ...
  weather: [
    {
      ...
      summary: "Extreme Weather Events. Irrigation pivots run dry in a heat that doesn’t break. Deal with this farm’s water, and invent something that holds as the weather keeps getting harsher.",
      scene:
    ...
    },
    {
      ...
      summary: "Extreme Weather Events. Fire weather turns noon orange. Protect people this afternoon without making the next fire worse.",
      scene:
    ...
    },
    {
      ...
      summary: "Extreme Weather Events. The river takes the same bend again. Keep homes dry this flood, and change the ground so it doesn’t keep happening.",
      scene:
    ...
    },
    {
      ...
      summary: "Extreme Weather Events. Sirens come after the roof is already gone. Warn in time, and build so the next storm doesn’t finish the job.",
      scene:
  ...
  mideast: [
    {
      ...
      summary: "Peace in the Middle East. Ambulances pay twice at the gate while someone bleeds. Get care through a checkpoint without funding the next war.",
      scene:
    ...
    },
    {
      ...
      summary: "Peace in the Middle East. Shops only open after the power cut lifts. Keep a street alive through the blackout without hardening the siege.",
      scene:
    ...
    },
    {
      ...
      summary: "Peace in the Middle East. Winter walls never rise. Shelter people now without locking in a permanent camp.",
      scene:
    ...
    },
    {
      ...
      summary: "Peace in the Middle East. A canal gate becomes a weapon. Share water so it can’t be used to starve a side.",
      scene:
  ...
  nuclear: [
    {
      ...
      summary: "Nuclear Annihilation. Sirens over grain country with no shared picture of what’s inbound. Slow the panic, and keep a false alarm from becoming a launch.",
      scene:
    ...
    },
    {
      ...
      summary: "Nuclear Annihilation. Ice clutter on a radar looks like an inbound strike. Tell weather from a missile before someone has to guess.",
      scene:
    ...
    },
    {
      ...
      summary: "Nuclear Annihilation. Drills run without a shared clock. Get everyone on the same second before a real alert.",
      scene:
    ...
    },
    {
      ...
      summary: "Nuclear Annihilation. A patch night almost sends a launch order. Make the software boring enough that a near-send can’t happen.",
      scene:
  ...
  slavery: [
    {
      ...
      summary: "Slavery. Identity papers sit locked below the ice line so workers can’t leave. Free the papers without dumping people with nothing.",
      scene:
    ...
    },
    {
      ...
      summary: "Slavery. A scale never zeros the loan, so the debt never ends. Make the wage real, not a forever tab.",
      scene:
    ...
    },
    {
      ...
      summary: "Slavery. Knot counts after midnight hide forced labor in a hold. See the people the ledger pretends aren’t there.",
      scene:
    ...
    },
    {
      ...
      summary: "Slavery. Ore sacks replace schoolbags. Get kids out of the pit without collapsing the only cash in town.",
      scene:
  ...
  women: [
    {
      ...
      summary: "Equal Rights for Women. The walk home after midnight is the actual commute tax. Make the trip safe without telling her to stay in.",
      scene:
    ...
    },
    {
      ...
      summary: "Equal Rights for Women. A deed still needs his name. Make ownership real on paper, not a favor.",
      scene:
    ...
    },
    {
      ...
      summary: "Equal Rights for Women. The welding bay closes at dusk so she misses the overtime. Keep skilled work open without a curfew for one gender.",
      scene:
    ...
    },
    {
      ...
      summary: "Equal Rights for Women. A form still wants his signature. Let her sign her own life.",
      scene:
  ...
  education: [
    {
      ...
      summary: "Lack of Education. Flood weeks erase a whole grade. Keep learning going when the building is underwater.",
      scene:
    ...
    },
    {
      ...
      summary: "Lack of Education. Exams in only one language strand kids who can do the work. Test what they know, not which tongue they were born into.",
      scene:
    ...
    },
    {
      ...
      summary: "Lack of Education. Blackout classrooms empty by noon. Teach through heat and no power.",
      scene:
    ...
    },
    {
      ...
      summary: "Lack of Education. Teen caregivers miss the credit clock. Count the learning that happens around care, not only the bell.",
      scene:
  ...
  automation: [
    {
      ...
      summary: "Automation / UBI. Aisles pick themselves and the people don’t. Deal with this week’s lost hours, and invent a future where the gains don’t only go upstairs.",
      scene:
    ...
    },
    {
      ...
      summary: "Automation / UBI. Taxi medallions sit against empty curbs. Replace the fare without stranding the driver.",
      scene:
    ...
    },
    {
      ...
      summary: "Automation / UBI. Charts get coded without the wing that used to know the plane. Keep the human in the loop without pretending the model can’t fly.",
      scene:
    ...
    },
    {
      ...
      summary: "Automation / UBI. Sorters took the piece-rate weeks. Pay and purpose after the line no longer needs hands.",
      scene:
  ...
  refugees: [
    {
      ...
      summary: "Refugees. Hostels are full and the stamp is still pending. Shelter people now without freezing them in a forever wait.",
      scene:
    ...
    },
    {
      ...
      summary: "Refugees. A second breach and no parcel left. Get aid to the new arrivals without starving the last ones.",
      scene:
    ...
    },
    {
      ...
      summary: "Refugees. Wounded wait at a ridge clinic gate. Treat people on the move without a passport that doesn’t exist yet.",
      scene:
    ...
    },
    {
      ...
      summary: "Refugees. Ferries cut and addresses sink. Keep a family findable when the map is gone.",
      scene:
  ...
  ag: [
    {
      ...
      summary: "Sustainable Agriculture. Bare winter fields blow the county thin. Cover the soil this season, and invent farming that doesn’t spend the topsoil.",
      scene:
    ...
    },
    {
      ...
      summary: "Sustainable Agriculture. A spice rush kills the mist forest. Keep the crop without razing the canopy that makes rain.",
      scene:
    ...
    },
    {
      ...
      summary: "Sustainable Agriculture. Spec sheets turn salad rows into spray alleys. Grow the contract without drowning the field in chemistry.",
      scene:
    ...
    },
    {
      ...
      summary: "Sustainable Agriculture. Pump wars salt the seed beds. Share water so this year’s yield doesn’t kill next year’s dirt.",
      scene:
  ...
  food: [
    {
      ...
      summary: "Food Security. Blight takes the parish potatoes. Feed people this winter, and stop the next blight from emptying the store.",
      scene:
    ...
    },
    {
      ...
      summary: "Food Security. Dawn crates rot at the gate. Get food through before it dies in the heat.",
      scene:
    ...
    },
    {
      ...
      summary: "Food Security. Wells on the circuit turn to mud. Grow food when the water table quits.",
      scene:
    ...
    },
    {
      ...
      summary: "Food Security. Barges pass the small jetties by. Feed the places the big boats skip.",
      scene:
  ...
  eco: [
    {
      ...
      summary: "Ecological Crises. Cranes over concrete where a wetland used to slow the flood. Save what’s left, and invent growth that doesn’t pave the last habitat.",
      scene:
    ...
    },
    {
      ...
      summary: "Ecological Crises. Empty nets at the weir. Fish tonight without wiping the run.",
      scene:
    ...
    },
    {
      ...
      summary: "Ecological Crises. Sand where meadows waved. Hold the dune without killing what grew there.",
      scene:
    ...
    },
    {
      ...
      summary: "Ecological Crises. Spring without frogs. Bring the chorus back without a one-season stunt.",
      scene:
  ...
  infectious: [
    {
      ...
      summary: "Infectious Diseases. Medical waste tips fever into a lane. Stop this outbreak, and keep clinic trash from becoming the next one.",
      scene:
    ...
    },
    {
      ...
      summary: "Infectious Diseases. A shared cistern cough fills a lodge. Cut the waterborne spread without cutting the only tap.",
      scene:
    ...
    },
    {
      ...
      summary: "Infectious Diseases. Gutting rinse sickens the landings. Clean the catch without poisoning the harbor.",
      scene:
    ...
    },
    {
      ...
      summary: "Infectious Diseases. A playground pump empties school desks. Keep kids in class when the water is the vector.",
      scene:
  ...
  climate: [
    {
      ...
      summary: "Climate crises. A paved boom sends floodwater downhill. Deal with this ward’s water, and invent something that actually moves the needle on warming.",
      scene:
    ...
    },
    {
      ...
      summary: "Climate crises. It’s too hot — it doesn’t even cool down overnight. The local problem is dealing with the heat. The global problem is inventing something that actually moves the needle on warming.",
      scene:
    ...
    },
    {
      ...
      summary: "Climate crises. Ocean currents are shifting, so fisheries can’t find fish the way they used to. Invent something sustainable that doesn’t make the long run worse.",
      scene:
    ...
    },
    {
      ...
      summary: "Climate crises. An inversion traps dirty air over a mill town. Let kids breathe this week, and cut what the stacks put in the sky.",
      scene:
  ...
  cancer: [
    {
      ...
      summary: "Cure Cancer. Old burns still seed tumors on the beach circuit. Catch disease earlier here, and stop the exposure that keeps making it.",
      scene:
    ...
    },
    {
      ...
      summary: "Cure Cancer. Playground vapors nobody capped. Find the cancers sooner, and shut the leak that starts them.",
      scene:
    ...
    },
    {
      ...
      summary: "Cure Cancer. Solvent booths trade lungs for tips. Screen workers in time, and change the job so the solvent isn’t the wage.",
      scene:
    ...
    },
    {
      ...
      summary: "Cure Cancer. Night resin lines still mark the livers. Detect damage early without leaving the line as the cause.",
      scene:
  ...
  mental: [
    {
      ...
      summary: "Mental Health Crises. The waitlist is longer than the semester. Get help now, and invent care that isn’t a year-long queue.",
      scene:
    ...
    },
    {
      ...
      summary: "Mental Health Crises. The line never slows for grief. Make room for the people the queue treats as leftover.",
      scene:
    ...
    },
    {
      ...
      summary: "Mental Health Crises. Twelve-hour hearts running empty. Keep night staff from breaking, and change the shift math that causes it.",
      scene:
    ...
    },
    {
      ...
      summary: "Mental Health Crises. Five stars or the spiral. Ratings that punish honesty make people worse. Invent a check-in that doesn’t farm despair.",
      scene:
  ...
  alzheimer: [
    {
      ...
      summary: "Alzheimer. Dusk walks past the grain bins and nobody knows where home is. Keep people safe tonight, and invent care that still knows who they are.",
      scene:
    ...
    },
    {
      ...
      summary: "Alzheimer. Three floors, one night aide. Cover the night without pretending one person can be everywhere.",
      scene:
    ...
    },
    {
      ...
      summary: "Alzheimer. After the midnight caregiving shift, the family is the clinic. Support the household, not only the ward.",
      scene:
    ...
    },
    {
      ...
      summary: "Alzheimer. Prayers between bus transfers. Make follow-up survive a commute, not only a memory clinic.",
      scene:
  ...
  ageing: [
    {
      ...
      summary: "Ageing as a Disease. Doubles until the body breaks. Ease this job, and invent work and care that don’t treat age as a write-off.",
      scene:
    ...
    },
    {
      ...
      summary: "Ageing as a Disease. Kilns that outlast bones. Keep older workers whole, not just employed.",
      scene:
    ...
    },
    {
      ...
      summary: "Ageing as a Disease. Upper floors without cool air. Heat is a healthspan problem. Cool the night without cooking the grid.",
      scene:
    ...
    },
    {
      ...
      summary: "Ageing as a Disease. Dawn stalls without successors. Pass the skill on before the last hands quit.",
      scene:
  ...
  water: [
    {
      ...
      summary: "Clean Water. Standpipes sputter brown. Drink today, and fix the system that keeps sending mud.",
      scene:
    ...
    },
    {
      ...
      summary: "Clean Water. Green film coats the step wells. Make the water safe without a forever boil order.",
      scene:
    ...
    },
    {
      ...
      summary: "Clean Water. Boil orders never lift at the night clinic. Treat patients when the tap itself is the infection.",
      scene:
    ...
    },
    {
      ...
      summary: "Clean Water. Guest pools win, alley taps lose. Share the clean water, not only the tourism photo.",
      scene:
  ...
  air: [
    {
      ...
      summary: "Air Pollution. Bunker smoke on wash day. Breathe this morning, and cut the fuel that keeps painting the laundry gray.",
      scene:
    ...
    },
    {
      ...
      summary: "Air Pollution. Recess under the flyover. Kids eat exhaust with lunch. Clean the hour before math, and the traffic that makes it.",
      scene:
    ...
    },
    {
      ...
      summary: "Air Pollution. Evening fires in the lane. Cook without filling the alley with smoke.",
      scene:
    ...
    },
    {
      ...
      summary: "Air Pollution. Colored fog at shift change. See what the plant vents, and stop it at the stack.",
      scene:
  ...
  "energy-access": [
    {
      ...
      summary: "Access to Energy. Coal smoke fills the gap the grid left. Light and heat tonight without locking in the dirty fill-in.",
      scene:
    ...
    },
    {
      ...
      summary: "Access to Energy. Harvest waits while the genset coughs. Power the mill when the grid isn’t there.",
      scene:
    ...
    },
    {
      ...
      summary: "Access to Energy. The sterilizer sleeps through the night shift. Keep clinic tools hot when the wires are dead.",
      scene:
    ...
    },
    {
      ...
      summary: "Access to Energy. Light sold by the hour on the lagoon. Make power a service, not a meter that shuts families off.",
      scene:
  ...
  homeless: [
    {
      ...
      summary: "Homelessness. Noon checkout into a furnace lot. Shelter through the heat, and invent housing that isn’t a 24-hour eviction.",
      scene:
    ...
    },
    {
      ...
      summary: "Homelessness. Thirty safe nights, then the courthouse lot. Stop the clock that dumps people back on the pavement.",
      scene:
    ...
    },
    {
      ...
      summary: "Homelessness. Sold out from under the fixed check. Keep the rent from being a one-way ticket out.",
      scene:
    ...
    },
    {
      ...
      summary: "Homelessness. Discharged still weak to the ambulance bay. A hospital exit is not a home. Close that gap.",
      scene:
  ...
  cities: [
    {
      ...
      summary: "Cities / Urbanization. Tin roofs that still cook after dark. Cool the night in the informal city, and invent growth that doesn’t bake people.",
      scene:
    ...
    },
    {
      ...
      summary: "Cities / Urbanization. The estero became the alley dump. Drain the flood and the trash without pushing either onto the next block.",
      scene:
    ...
    },
    {
      ...
      summary: "Cities / Urbanization. Three hours down the ridge for a shift. Shorten the commute without pushing the poor farther out.",
      scene:
    ...
    },
    {
      ...
      summary: "Cities / Urbanization. Lessons under the zinc sheets. School in a growing city shouldn’t be a hot shed.",
      scene:
  ...
  child: [
    {
      ...
      summary: "Child Health. Night smoke steals small breaths. Let kids sleep, and cut the smoke that keeps making them sick.",
      scene:
    ...
    },
    {
      ...
      summary: "Child Health. Trash gutters breed the fever. Stop this outbreak, and fix the ditch that feeds it.",
      scene:
    ...
    },
    {
      ...
      summary: "Child Health. Spoiled millet on the growth chart. Feed kids this month without a warehouse that spoils the staple.",
      scene:
    ...
    },
    {
      ...
      summary: "Child Health. Battery dust on the play sand. Keep play from being a poison, and stop the dump at the source.",
      scene:
  ...
  maternal: [
    {
      ...
      summary: "Maternal Health. A bamboo stretcher at the switchback. Get a woman to care in time, and invent birth that doesn’t depend on a heroic walk.",
      scene:
    ...
    },
    {
      ...
      summary: "Maternal Health. Night heat on the birth floor. Keep labor safe when the room won’t cool.",
      scene:
    ...
    },
    {
      ...
      summary: "Maternal Health. Dust in the labor queue. Clean air and a real place in line, not a courtyard wait.",
      scene:
    ...
    },
    {
      ...
      summary: "Maternal Health. Warm vials at low tide. Keep the shot cold when the boat is late.",
      scene:
  ...
  coord: [
    {
      ...
      summary: "Global Coordination Failure. Lakes that will not speak together. Share the warning so one shore isn’t blind.",
      scene:
    ...
    },
    {
      ...
      summary: "Global Coordination Failure. Three cities, one heat wave, no shared fund. Cool people now, and invent a response that isn’t every town for itself.",
      scene:
    ...
    },
    {
      ...
      summary: "Global Coordination Failure. Nets empty, logbooks closed. Fish stocks don’t respect borders. Count together or lose together.",
      scene:
    ...
    },
    {
      ...
      summary: "Global Coordination Failure. Shore towns, separate water truths. One flood model, not four arguments.",
      scene:
  ...
  radicalization: [
    {
      ...
      summary: "Countering Radicalization. A layoff notice, then new names on the wall. Offer an off-ramp that isn’t a sermon, and starve the pipeline.",
      scene:
    ...
    },
    {
      ...
      summary: "Countering Radicalization. Closed clinic, open airwaves. Care that vanished is how a broadcast fills the gap. Put help back before the hate does.",
      scene:
    ...
    },
    {
      ...
      summary: "Countering Radicalization. Cut routes, louder break room. Isolation at work is a recruiter’s friend. Keep people in the real room.",
      scene:
    ...
    },
    {
      ...
      summary: "Countering Radicalization. Standing terrace, softer recruiters. A stadium chant can become a hunt. Invent belonging that doesn’t need an enemy.",
      scene:
  ...
  fgm: [
    {
      ...
      summary: "Female Genital Mutilation (FGM). Stamps still bless the cut. End the practice without driving it into the dark.",
      scene:
    ...
    },
    {
      ...
      summary: "Female Genital Mutilation (FGM). Grove dues open the bush. Change the money and the rite so girls aren’t the fee.",
      scene:
    ...
    },
    {
      ...
      summary: "Female Genital Mutilation (FGM). Dawn bookings in the women’s lanes. Catch the schedule of harm, and offer a real alternative.",
      scene:
    ...
    },
    {
      ...
      summary: "Female Genital Mutilation (FGM). Elders still name the pure bride. Shift honor off the cut without abandoning the girl.",
      scene:
  ...
  "short-termism": [
    {
      ...
      summary: "Short-Term Needs vs Long-Term Future. Cash kilns thin the storm belt. Pay this month without selling the trees that stop the next storm.",
      scene:
    ...
    },
    {
      ...
      summary: "Short-Term Needs vs Long-Term Future. Exam scores, locked workshops. Teach for the test without killing the shop that feeds a life.",
      scene:
    ...
    },
    {
      ...
      summary: "Short-Term Needs vs Long-Term Future. Rent due, stairs failing. Patch the stair and invent a lease that doesn’t eat the building.",
      scene:
    ...
    },
    {
      ...
      summary: "Short-Term Needs vs Long-Term Future. Spring flood sold as dry fields. Don’t sell tomorrow’s ground for this season’s cash.",
      scene:
  ...
  misinfo: [
    {
      ...
      summary: "Misinformation & Epistemic Crises. The nurse who never dialed. A fake call can empty a clinic. Make the real signal cheaper to trust than the fake.",
      scene:
    ...
    },
    {
      ...
      summary: "Misinformation & Epistemic Crises. Sirens nobody believes. When the last scare was a lie, the real one is ignored. Rebuild the warning.",
      scene:
    ...
    },
    {
      ...
      summary: "Misinformation & Epistemic Crises. The lecture that wasn’t sold. A deepfake class can tank a career. Prove what was actually said.",
      scene:
    ...
    },
    {
      ...
      summary: "Misinformation & Epistemic Crises. Rent strike on a forged memo. Fake paper moves a crowd. Invent a check that still lets people organize.",
      scene:
  ...
  totalitarianism: [
    {
      ...
      summary: "Totalitarianism. The ward docks your household for the wrong post. Keep a family fed without feeding the score.",
      scene:
    ...
    },
    {
      ...
      summary: "Totalitarianism. No chant, no cold storage. Loyalty tests on the freezer. Share food without a pledge.",
      scene:
    ...
    },
    {
      ...
      summary: "Totalitarianism. Compliant blocks stay lit. Power as a political switch. Light that isn’t a reward for silence.",
      scene:
    ...
    },
    {
      ...
      summary: "Totalitarianism. Fuel only for the logged crew. Movement as a permit. Invent mobility that isn’t a leash.",
      scene:
  ...
  "women-stem": [
    {
      ...
      summary: "STEM for Women. Night shuttle ends before her bench time. Let her finish the lab without a ride that quits.",
      scene:
    ...
    },
    {
      ...
      summary: "STEM for Women. Sensor tickets still list the sons. Credit the work to the person who did it.",
      scene:
    ...
    },
    {
      ...
      summary: "STEM for Women. Repair floor badge never prints for her. Open the trade without a gate that only fits one gender.",
      scene:
    ...
    },
    {
      ...
      summary: "STEM for Women. Travel fund needs a male chaperone. Send her to the conference as herself.",
      scene:
  ...
  memory: [
    {
      ...
      summary: "Incomplete Memory. Joinery marks leave with the last master. Save the how before the hands are gone.",
      scene:
    ...
    },
    {
      ...
      summary: "Incomplete Memory. Safe ice only the aunties can name. Map the knowledge so a thaw doesn’t erase it.",
      scene:
    ...
    },
    {
      ...
      summary: "Incomplete Memory. The furnace whisper dies at shift end. Record the craft without turning workers into content.",
      scene:
    ...
    },
    {
      ...
      summary: "Incomplete Memory. Auntie remedies never reach the chart. Get lived medicine into care without stealing it.",
      scene:
  ...
  "rural-roads": [
    {
      ...
      summary: "Rural Road Connectivity. Harvest trucks stop at the broken bailey. Get the crop out, and invent a crossing that survives the next flood.",
      scene:
    ...
    },
    {
      ...
      summary: "Rural Road Connectivity. A clinic boat cannot beat the cut-off levee. Reach care when the road is a canal.",
      scene:
    ...
    },
    {
      ...
      summary: "Rural Road Connectivity. The winter school bus never clears the dune line. Keep school in session when sand wins.",
      scene:
    ...
    },
    {
      ...
      summary: "Rural Road Connectivity. Fuel and dialysis miss the thaw window. Time the supply to the mud, not the calendar.",
      scene:
  ...
  smoking: [
    {
      ...
      summary: "Smoking. The gate line runs on shared packs. Quit without losing the only break that feels like a team.",
      scene:
    ...
    },
    {
      ...
      summary: "Smoking. Snack carts sell the first drag. Stop the first cigarette without banning the cart that feeds the shift.",
      scene:
    ...
    },
    {
      ...
      summary: "Smoking. Dock break rooms still billow. Clean air at work, and a real off-ramp from the pack.",
      scene:
    ...
    },
    {
      ...
      summary: "Smoking. Courtyard haze reaches the newborn cots. Protect the cots, and cut the smoke at the source.",
      scene:
  ...
  sanitation: [
    {
      ...
      summary: "Sanitation. Latrine queues send girls home by noon. A toilet is a school day. Invent sanitation that lets them stay.",
      scene:
    ...
    },
    {
      ...
      summary: "Sanitation. Sewage owns the only stair out. Drain the building without dumping on the next one.",
      scene:
    ...
    },
    {
      ...
      summary: "Sanitation. Behind the fuel bay is the toilet. Dignity at work, and waste that doesn’t sit in the open.",
      scene:
    ...
    },
    {
      ...
      summary: "Sanitation. The wing that smells before breakfast. Hospital sewage is a care failure. Fix the pipe, not only the spray.",
      scene:
  ...
  waste: [
    {
      ...
      summary: "Waste & Recycling. Smoke over the circuit from burning packs. Stop this burn, and invent a loop that isn’t a dump.",
      scene:
    ...
    },
    {
      ...
      summary: "Waste & Recycling. Swollen packs behind the shed. Collect what the city won’t, without a new pile.",
      scene:
    ...
    },
    {
      ...
      summary: "Waste & Recycling. Trays stacked to the dorm vents. Campus waste in the air. Close the loop on the tray.",
      scene:
    ...
    },
    {
      ...
      summary: "Waste & Recycling. Linen that washes out to sea. Stop the micro-dump, and keep the laundry running.",
      scene:
  ...
  reproductive: [
    {
      ...
      summary: "Reproductive Health. Ninety minutes past the last contraction. Get postpartum care in time, not after the window.",
      scene:
    ...
    },
    {
      ...
      summary: "Reproductive Health. High water blocks the midwife boat. Birth doesn’t wait on a tide. Reach her anyway.",
      scene:
    ...
    },
    {
      ...
      summary: "Reproductive Health. The sponsor keeps her health card. Her body, her card. Invent access that isn’t a leash.",
      scene:
    ...
    },
    {
      ...
      summary: "Reproductive Health. She arrives already mid-pregnancy. Catch care earlier without a gate that punishes the late arrival.",
      scene:
  ...
  amr: [
    {
      ...
      summary: "Antimicrobial Resistance. The pharma drain tutors the tanks. Stop the leftover drugs from teaching the river.",
      scene:
    ...
    },
    {
      ...
      summary: "Antimicrobial Resistance. Port lungs outlast the formulary. The last good drug is gone. Invent a path that isn’t one more pill dumped into the air.",
      scene:
    ...
    },
    {
      ...
      summary: "Antimicrobial Resistance. Barn routine poisons the creek clinics. Farm use shows up in people. Change the routine without starving the herd.",
      scene:
    ...
    },
    {
      ...
      summary: "Antimicrobial Resistance. Lane chemists empty the last good drugs. Steward what still works, and invent what comes after.",
      scene:
  ...
  _default: [
    {
      ...
      summary: "This global problem lands in daily life. Deal with the harm here, and invent something that doesn’t make the long run worse.",
      scene:
