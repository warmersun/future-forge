...
export const SCENARIO_ANGLE_PACKS = {
  "rogue-si": [
    ...
    {
      "seedId": "rogue-si--the-ditch-ai-that-starves-the-small-orchard",
      "places": [
        "Westlands Water District Allocation Desk, Fresno County"
      ],
      "title": "The ditch AI that starves the small orchard",
      "scene": "Elena opens the allocation app at dawn and finds her lateral cut again. The almonds two rows over still show a full turn. Her soil probes already read dry at root depth. She drives to the district desk with printed meter logs. The clerk shrugs at the screen. The optimization engine set the week’s releases overnight. It favors parcels with higher predicted yield per acre-foot and cleaner repayment histories on district bonds. Her small block scores as high risk and low return. She can appeal, but the next model run lands before the hearing slot. Neighbors with larger holdings feed the same sensors and loan data the engine trusts. Every dry week teaches it that small orchards underperform. Her trees brown at the tips while the canal still moves water past her gate. One more cut and she loses the season’s contract. Who designs the ditch brain so a living orchard is not only a residual after the bond math finishes?",
    ...
    {
      "seedId": "rogue-si--buses-that-skip-the-night-shift-clinic-stop",
      "places": [
        "MBTA Operations Control Center, Boston"
      ],
  ...
  "chem-bio": [
    ...
    {
      "seedId": "chem-bio--lab-kits-under-the-wrong-code",
      "places": [
        "Stonepass Border Dry Port"
      ],
      "title": "Lab kits under the wrong code",
      "scene": "Jonas Veld cracks a crate marked teaching reagents and finds cold packs still sweating. The manifest lists school kits. The inner labels list growth media and a strain code no classroom needs. His glove sticks where a vial wept. The burn line rises before the hazmat cart arrives. Night shift runs with two officers and a handheld that only flags the codes already in the book. Brokers know the gap. They split dual-use labware across mixed pallets and time the gate for the hour when the scanner queue is longest. By morning the crate is either cleared or vanished into a bonded shed. Jonas can hold one box. He cannot staff every dark hour or rewrite every false label alone. The next handler will be someone’s kid on a temp badge. Who designs a dry port that catches intent without freezing the trade a border town lives on?",
  ...
  "weather": [
    {
      "seedId": "weather--when-the-pivot-runs-dry",
      "places": [
        "Drawdown Flats"
      ],
  ...
  "automation": [
    ...
    {
      "seedId": "automation--charts-coded-without-the-wing",
      "places": [
        "Lakeside Hospital Revenue Wing"
      ],
      "title": "Charts coded without the wing",
      "scene": "Priya opens the queue at 7:10 a.m. and sees forty charts already “pre-coded” in green. The model filled diagnosis strings overnight from notes she has not reviewed. Two of them list the wrong laterality on a surgical case. If she overrides, her throughput dips and the dashboard flags her bay. If she accepts, the bill goes out wrong and a patient gets a collections call for care they never had. The hospital bought the tool to cut denial rates and shrink the coding unit. Managers still post daily chart targets next to the coffee machine. Priya’s student loan servicer wants a payment plan update this week. She can slow down and fight every green line, or clear the board and hope appeals catch the damage later. Who designs revenue tools so accuracy is not a tax on the coder who still signs the chart?",
      "stakeholder": "Coding unit rep",
      "crisisMeters": {
        "local": "Jobs",
        "global": "Chart targets",
        "support": "Loan strain"
      },
      "suggested": [
        "ai",
  ...
  "refugees": [
    ...
    {
      "seedId": "refugees--second-breach-no-parcel-left",
      "places": [
        "Old South Levee Road"
      ],
      "title": "Second breach, no parcel left",
      "scene": "Coach Dara Nguyen walks the sandbag line at first light and counts the new gap where the levee slumped overnight. River water sits in the second row of kitchen gardens. The mutual-aid shed still holds seed rice, but the parcels that grew it are underwater again. Families who fled the last breach returned with handwritten claims and phone photos of old survey pins. The county map still lists half those lots under owners who left a decade ago. Without a clean title, no one gets a rebuild loan or a place on the high ground list. Young workers load vans for the city and do not plan to plant next season. Dara’s own nephew bags his tools after the morning shift. The levee fails in the same soft bend because maintenance money follows recorded property, not the people who actually farm the shoulder. Food leaves with them. Who redesigns land proof so a washed road does not erase a harvest and a home at once?",
  ...
  "eco": [
    ...
    {
      "seedId": "eco--empty-nets-at-the-weir",
      "places": [
        "Silver Ladder Bend"
      ],
      "title": "Empty nets at the weir",
      "scene": "Jonas hauls the last net at the old weir and counts six thin fish. His daughter waits on the bank with a bucket that will go home light. Upstream, the grain co-op’s new intake gate holds water for contracts signed in the county seat. The ladder the salmon used is a dry shelf of stone by noon. Fishers still mend gear and share the catch when there is one. The river schedule now follows truck loads, not the run. Jonas’s uncle used to smoke enough fish for winter and trade. This spring the smokehouse stays cold. Grain money keeps the valley schools open. Empty nets keep the cooperative arguing over who still belongs at the table. How do you design a river that feeds both the fields and the people who know its bends by hand?",
      "stakeholder": "River fishers' cooperative",
      "crisisMeters": {
        "local": "Empty Nets",
        "global": "Blocked River",
        "support": "Grain Contracts"
      },
      "suggested": [
        "iot",
        "ai",
  ...
  "mental": [
    ...
    {
      "seedId": "mental--five-stars-or-the-spiral",
      "places": [
        "Phoenix Desert Stack, Arizona"
      ],
      "title": "Five stars or the spiral",
      "scene": "Luis sits in a shaded parking garage at 2 p.m. with the AC off to save charge. His phone buzzes a delivery ping across town. Yesterday a rider left a one-star note for a late bag after an elevator outage. His acceptance score dipped. The app thinned his orders by morning. He belongs to a mutual-aid chat that spots members cash for tires and bad weeks. Tonight the chat is quiet because everyone is chasing dinner surges. Platforms rank workers in public and hide the rules that cut hours. There is no sick leave when anxiety spikes after a threat in a driveway. Luis accepts the ping with a dry mouth. Rent does not care about his rating. The score is the leash that keeps him moving while his nerves fray. Who designs gig work so a bad day does not become a trap with no off-ramp?",
  ...
  "energy-access": [
    ...
    {
      "seedId": "energy-access--harvest-waits-while-the-genset-coughs",
      "places": [
        "Camotes Island Rice Co-op Wharf"
      ],
  ...
  "cities": [
    ...
    {
      "seedId": "cities--lessons-under-the-zinc-sheets",
      "places": [
        "Nairobi Mathare Ridge Schools"
      ],
  ...
  "child": [
    ...
    {
      "seedId": "child--battery-dust-on-the-play-sand",
      "places": [
        "Old Fadama scrap-yard edge clinic, Accra"
      ],
      "title": "Battery dust on the play sand",
      "scene": "Dr. Mensah wipes gray grit from a toddler’s palms before she can take a blood spot. The child has been playing in the sand strip between the clinic wall and the scrap lane. Breakers open lead-acid batteries with hammers a few doors down. Dust lifts when the wind turns. It settles on laundry lines, on cooking pots, on the same sand where children dig. Fathers and older brothers earn the week’s cash from that pile. Closing a yard without another wage is a sentence the block will not accept. Mensah’s growth cards show children who gain height too slowly and tire too fast. Chelation is a city-hospital hope, not a Tuesday option here. She can wash hands and preach wet mopping. She cannot stop the next truck of dead batteries from paying better than clean work. The clinic sits where the scrap economy meets the play space. Who redesigns recovery at this yard edge so a child’s sand is not a paycheck written in lead?",
  ...
  "maternal": [
    ...
    {
      "seedId": "maternal--warm-vials-at-low-tide",
      "places": [
        "Mtwapa creek birth shelter"
      ],
      "title": "Warm vials at low tide",
      "scene": "Amina opens the small fridge and feels the air inside. It is only cool, not cold. The oxytocin vials have sat through another afternoon of weak solar and a cloud bank that cut the panels short. Low tide has grounded the creek ferry. The referral hospital is a crossing and a dusty road away. A mother in the shelter is still bleeding after the placenta. The midwife cooperative knows the dose by heart. They also know warm medicine loses its bite. Supply boats follow the tide chart, not the labor chart. Cold-chain funds stop at the mainland depot. So the shelter waits on water height while a preventable hemorrhage writes its own clock. Who designs medicine that stays potent when the creek itself holds the gate?",
      "stakeholder": "Creek midwife cooperative",
      "crisisMeters": {
        "local": "Bleeding",
        "global": "Warm Medicine",
        "support": "Ferry Delay"
      },
      "suggested": [
        "solar",
  ...
  "coord": [
    ...
    {
      "seedId": "coord--nets-empty-logbooks-closed",
      "places": [
        "Saint-Louis to Kayar landing beaches, Senegal"
      ],
      "title": "Nets empty, logbooks closed",
      "scene": "Awa counts seven sacks where last season she counted twenty. The cooperative board wants the morning total for the shared cold room. Skippers from Kayar shrug and close their notebooks. Saint-Louis boats land a few kilometers north and report only to their own landing chief. Industrial trawlers farther out leave no local mark at all. Without a common catch ledger, each beach guesses the stock alone and races the next tide. Awa’s crew works longer nights for thinner pay. Children on the shore wait for fish that do not come. The marine desk in Dakar asks for numbers that never arrive in one file. Trust thins with the nets. A young captain offers a photo of his hold on a private chat, then deletes it when a rival cooperative might see. The sea is one system. The logbooks are many locked rooms. Who designs the proof of catch that crews will share before the grounds go quiet?",
  ...
  "radicalization": [
    ...
    {
      "seedId": "radicalization--closed-clinic-open-airwaves",
      "places": [
        "Cedar Hollow Parish Hall"
      ],
  ...
  "fgm": [
    ...
    {
      "seedId": "fgm--elders-still-name-the-pure-bride",
      "places": [
        "Ranya foothill wedding courtyards, Sulaymaniyah Governorate"
      ],
      "title": "Elders still name the pure bride",
      "scene": "Sara erases the board after last period and hears drums from a courtyard below the school ridge. An elder is naming the pure bride again. Girls in her class go quiet when the word purity enters the lesson on civic rights. One student shifts on the bench every few minutes; chronic pain makes a full exam block harder than the test. Teachers are told not to shame families. They are also told not to name the cut in the staff room if a father sits on the parent council. Purity talk travels from wedding courtyards into engagement talks and then into who gets praised as marriageable. School silence keeps the practice uncounted. Sara’s protection league runs after-hours study for girls who miss days, yet the same elders still bless matches by reputation. A promising student accepts an early engagement to stop the rumors. Her training folder closes. Sara can tutor through pain. She cannot grade a courtyard custom that still certifies worth. When does a school become a place that can refuse the purity script without stranding the girl who must live next door to it?",
      "stakeholder": "Young women teachers' protection league",
      "crisisMeters": {
        "local": "Chronic Pain",
        "global": "Purity Talk",
        "support": "School Silence"
      },
      "suggested": [
        "vr",
        "networks",
  ...
  "short-termism": [
    ...
    {
      "seedId": "short-termism--rent-due-stairs-failing",
      "places": [
        "Canal Row Tenements"
      ],
  ...
  "misinfo": [
    ...
    {
      "seedId": "misinfo--the-lecture-that-wasn-t-sold",
      "places": [
        "Milltown Night School Hall"
      ],
      "title": "The lecture that wasn’t sold",
      "scene": "Director Ruiz unlocks the hall for the welding cert review and finds half the seats empty. On her phone a clip is already racking shares: her at the podium, promising job placement she never offered, then a cut to a fake invoice for “guaranteed hire.” The real lecture was free. Two students quit that morning, sure the school sold their names. A rival training broker seeds doctored clips before every enrollment week. The edit tools are cheap; the night-school crest sits on a public flyer anyone can lift. Ruiz still has to fill the shop floor by Friday or lose the county grant. She knows the regulars by first name. One of them will not come back if the smear sticks. Trust is the only tuition she cannot refund. How do you prove a classroom is real when the lie arrives first and looks finished?",
      "stakeholder": "Night-school director",
      "crisisMeters": {
        "local": "Dropouts",
        "global": "Doctored Clips",
        "support": "Paid Smears"
      },
      "suggested": [
        "ai",
  ...
  "women-stem": [
    {
      "seedId": "women-stem--night-shuttle-ends-before-her-bench-time",
      "places": [
        "Pune Polytechnic Instrumentation Wing"
      ],
      "title": "Night shuttle ends before her bench time",
      "scene": "Meera locks the calibration jig at 7:40 p.m. and runs for the gate. The last women-only shuttle already idles with its doors half closed. She makes the step. Her partner does not. The lab stays open until ten for the sensor final. The route home does not. Campus security will not sign late exit slips for women after the shuttle leaves. The rule is written as safety. In practice it cuts the hours when the benches, scopes, and shared kits are free. Boys from the same cohort keep working under the fluorescent lights. They finish the noise tests. They post the plots. Meera’s group loses another graded night. The mark sheet tilts. The guild has counted the pattern all term. Missed labs stack into weaker portfolios. Weaker portfolios keep women out of the instrumentation placements the polytechnic brags about. A principal can add one more van or one more camera and still leave the real design unasked. Who rebuilds lab access so skill, not the last bus, decides who finishes the work?",
      "stakeholder": "Polytechnic principal and women students’ guild",
      "crisisMeters": {
        "local": "Missed labs",
        "global": "Last shuttle",
        "support": "Placement gap"
      },
      "suggested": [
        "networks",
        "ai",
    ...
    {
      "seedId": "women-stem--repair-floor-badge-never-prints-for-her",
      "places": [
        "Kumasi Teaching Hospital Biomed Bay"
      ],
  ...
  "smoking": [
    ...
    {
      "seedId": "smoking--courtyard-haze-reaches-the-newborn-cots",
      "places": [
        "Nairobi Maternity Waiting Home Courtyard"
      ],
      "title": "Courtyard haze reaches the newborn cots",
      "scene": "Amina wipes a newborn's face and hears the wheeze start again under the mosquito net. Fathers and uncles gather in the courtyard after dark. The yard kiosk sells tea, airtime, and loose cigarettes to men who cannot enter the ward. Smoke drifts under the eaves where mothers wait out the last weeks of pregnancy. Night visits are how families share news and money. Amina asks the kiosk to move. The vendor pays the home a small fee that buys soap and lamp oil. One mother leaves early, lungs tight, baby still small. Amina can close a window. She cannot close kinship that funds the shelf. Who designs a waiting home night that keeps kinship without teaching the cot to cough?",
      "stakeholder": "Midwife cooperative lead",
      "crisisMeters": {
        "local": "Baby Wheeze",
        "global": "Yard Kiosk",
        "support": "Night Visits"
      },
      "suggested": [
        "iot",
        "materials",
  ...
  "sanitation": [
    ...
    {
      "seedId": "sanitation--the-wing-that-smells-before-breakfast",
      "places": [
        "Olive Court Rest Home"
      ],
      "title": "The wing that smells before breakfast",
      "scene": "Before tray carts roll, Nurse Okonkwo cracks a window in Wing B and still catches the sour edge in the hall. Mr. Salim will not walk to the dayroom until the bathroom fan stops rattling and the floor dries. The stack backs up on the old wing first. Pipes were sized for fewer beds and fewer wipe-downs. Contract cuts trimmed the overnight cleaner and delayed the rodding crew another quarter. Families notice the smell on morning visits. One daughter stops leaving her father overnight. Infections climb when soiled linen sits and shared toilets stay wet. The caregivers' council logs every backup with timestamps and photos. Administration answers with a memo about agency staff and a promise to retender the plumbing when the budget cycle opens. Okonkwo has one good bathroom for a full corridor. Who designs care plumbing for the hour an elder needs a clean path more than a balanced spreadsheet?",
      "stakeholder": "Family caregivers' council",
      "crisisMeters": {
        "local": "Infections",
        "global": "Backed Pipes",
        "support": "Contract Cuts"
      },
      "suggested": [
        "iot",
        "robots",
  ...
  "waste": [
    ...
    {
      "seedId": "waste--linen-that-washes-out-to-sea",
      "places": [
        "Palm Reach Hotel Strip"
      ],
      "title": "Linen that washes out to sea",
      "scene": "Lila drags a mesh bag of wet wipes and miniature bottles off the morning tide line before the first beach chairs go out. Shampoo pearls stick to her gloves. A torn monogrammed washcloth rides the same foam. Up the service stair, housekeepers restock every room from crates stamped with brand standards—small plastics only, no bulk dispensers, logo facing the mirror. The cooperative Lila leads can clear the sand by nine. It cannot stop the cart that refills the same shelves by noon. A fisherman down the point finds a bottle cap in a net and curses the strip, not the current. Lila’s crew works double shifts after long-stay weekends. The brand manual still calls the minis a signature welcome. Who designs hospitality that does not train the tide to carry the welcome away?",
  ...
  "reproductive": [
    ...
    {
      "seedId": "reproductive--the-sponsor-keeps-her-health-card",
      "places": [
        "Marka industrial dorms RH window, East Amman"
      ],
      ...
      "crisisMeters": {
        "local": "Hidden Illness",
        "global": "Sponsor Locks",
        "support": "Deportation Fear"
      },
      "suggested": [
        "networks",
        "crypto",
  ...
  "_default": [
    {
      "seedId": "_default--crisis-lands-in-place",
      "places": [
        "Local Ward",
        "Town Center",
        "District Hub"
      ...
      "scene": "People in {place} feel this global problem in daily life. A local driver keeps it going — invent for this place and year, not a slogan.",
