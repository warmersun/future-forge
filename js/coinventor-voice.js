...
import { voiceContextFingerprint, userTranscriptIsFinal } from "./voice-context.js?v=voice-10";
...
const CAPTURE_WORKLET_URL = new URL("./voice-capture-worklet.js?v=voice-10", import.meta.url).href;
