# Spanish translation review pack

Side-by-side **English / Spanish** strings for review and correction.

| File | Contents | Entries (approx) |
|------|----------|------------------|
| [01-ui.md](./01-ui.md) | UI chrome (`locales/es/ui.json`) | 852 |
...
2. Change only text after **`ES:`** (or the ES block for long strings).
...
> Apply my corrections from `docs/i18n-review-es/`
...
- Regenerate this pack: `node scripts/i18n-export-review-md.mjs --locale es`
