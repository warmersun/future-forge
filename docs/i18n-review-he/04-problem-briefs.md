# Hebrew review — problem briefs (`locales/he/problem-briefs.json`)
...
חקלאות תעשייתית מאכילה מיליארדים אך פוגעת בקרקעות, מים ומגוון ביולוגי באזורים רבים. שיטות התחדשות ודיוק מתפשטות, עדיין חלק מיעוט מהשטח העולמי.
...
תמריצי תשואה לטווח קצר, נעילת תשומות, אי שוויון קרקעות, לחץ אקלימי ושווקים שמתמחרים פחות נזקים אקולוגיים.
...
חקלאות היי-טק שעובדת רק עבור הון גדול יכולה לנעול את החקלאים הקטנים. התאימו המצאות לקרקעות מקומיות, מים וידע חקלאי - לא חבילות יצוא בגודל אחד.
...
תהליכי הזדקנות ביולוגיים, אורח חיים וסביבה, ומערכות שנבנו לחיים קצרים יותר וטיפול אקוטי ולא לריבוי תחלואה ארוך.
...
הייפ אנטי אייג'ינג גובר על ראיות. המצאה מקומית צריכה לכוון לתפקוד, ניידות וגישה לטיפול - לא טענות על היפוך ההזדקנות בעשור הזה עבור עיר שלמה.
...
זיהום האוויר הסביבה והביתי מניע עומסי מחלות גדולים, במיוחד ליד תנועה, תעשייה ובישול בדלק מוצק. הניטור השתפר; מעברים נקיים אינם אחידים.
...
בעירה מאובנים, פליטות תעשייתיות, אבק ודלקים מוצקים בתוך הבית - בתוספת רגולציה חלשה ואי-שוויון בחשיפה לפי הכנסה בשכונה.
...
אלצהיימר ודמנציה קשורה גדלים עם הזדקנות האוכלוסיות. האפשרויות לשינוי מחלות מוגבלות ויקרות; רוב הטיפול הוא משפחתי וקהילתי תחת עומס גבוה.
...
ביולוגיה נוירודגנרטיבית מורכבת, אבחון מאוחר, טיפולים מוגבלים ומערכות טיפול לא מוכנות למחלה מתקדמת ארוכה.
...
חיידקים וחיידקים אחרים מתפתחים עמידות לאנטיביוטיקה ותרופות אנטי מיקרוביאליות. זיהומים וניתוחים נפוצים הופכים קשים יותר לטיפול; תרופות קו אחרון נכשלות בבתי חולים בעוד ששימוש לרעה בקהילה ושימוש בחווה מאיצים עמידות. זה לא נושא של התפרצות וירוסים - זה שחיקת היעילות האנטי-מיקרוביאלית.
...
שימוש יתר ושימוש לרעה באנטיביוטיקה בבני אדם ובבעלי חיים, אבחון חלש המאלץ טיפול עיוור, בקרת זיהומים לקויה והשקעה חסרה בתרופות אנטי-מיקרוביאליות חדשות ובניהול.
...
אל תמציא כאן "עוד אפליקציית מגיפה ויראלית". העדיפו סדרנות, אבחון מהיר של חיידקים, שינוי שיטות עבודה בחווה ובתי מרקחת, וגישה לתרופה הנכונה - לא מכירת אנטיביוטיקה בלתי מוגבלת. לשמר את היעילות; אל תמציא מערכות המעודדות יותר רישום עיוור.
...
המצאה מקומית עוסקת בדרך כלל בחישה, התרעה פומבית וחוסן אזרחי - לא קורות הסטה בקנה מידה עירוני. הימנע תביעת יתר של מדע בדיוני; התמקד בשותפויות זיהוי, תרגילים ולוגיסטיקה התאוששות אם הנושא הזה הוא המסגרת שלך.
...
אוטומציה ובינה מלאכותית כבר מעצבים מחדש מחסנים, משרדים, הובלה ושירות לקוחות. חלק מהעבודות נעלמות או מתבטלות; חדשים מופיעים בצורה לא אחידה. דיונים על UBI, מיומנויות חוזרות וקיצור שבועות עבודה הם קרבות מדיניות חיים.
...
תחליפי הון לעבודה שגרתית כאשר משתלם; פיגור צינורות כישורים; ביטוח סוציאלי נבנה לתעסוקה של המאה ה-20; חברות תופסות רווחי פרודוקטיביות מבלי לשתף.
...
ההישרדות השתפרה עבור סוגי סרטן רבים שבהם זמינים הקרנה וטיפול; אבחון מאוחר וגישה לא שוויונית עדיין מביאים למקרי מוות הניתנים למניעה, במיוחד באזורים בעלי משאבים נמוכים יותר.
...
ביולוגיה של צמיחת תאים בלתי מבוקרת, הזדקנות אוכלוסיות, גורמי סיכון (טבק, זיהומים, זיהום), וצווארי בקבוק של מערכת הבריאות בהדמיה, פתולוגיה ויכולת טיפול.
...
אל תמציא "לרפא כל סרטן בן לילה". העדיפו זיהוי מוקדם יותר, בדיקה, ניווט וגישה. טענות קליניות דורשות יושר טייס ושותפים.
...
נשק כימי וביולוגי אסורים על פי הסכמים מרכזיים, אך מחקר דו-שימושי, תאונות מעבדה וכוונות לא חוקיות נותרו סיכונים. זיהוי, ייחוס ומוכנות לבריאות הציבור אינם אחידים ברחבי העולם.
...
ידע וכלים מופצים במדע לגיטימי; האימות אינו מושלם; נורמות עלולות להישחק; מימון המוכנות עולה לאחר משברים ואז דועך; תמריצים לשימוש כפול במחקר ובתעשייה.
...
אל תמציא מערכות המקלות על ייצור פתוגנים או רעלים בסיכון גבוה. העדיפו גילוי, PPE, אמצעי נגד רפואיים וממשל שקוף. תביעות לשימוש כפול זקוקות לקווים אדומים קפדניים באיך זה עובד.
...
תמותת ילדים ירדה באופן דרמטי, אך עדיין מקרי מוות הניתנים למניעה מדלקת ריאות, שלשולים, מלריה ותת תזונה נמשכים היכן שהטיפול הראשוני והחיסונים מפגרים. פערי תזונה והתפתחות מוקדמת מעצבים תוצאות לכל החיים.
...
עוני, טיפול ראשוני חלש, פערי גישה לחיסון ותזונה, כשלים במים/תברואה וקשרים לבריאות האם שמתחילים לפני הלידה.
...
המצאות העומדות בפני משפחה זקוקות לאמון המטפל ולמציאות בשרשרת קרה. Avoid data collection without care capacity to act on results.
...
רוב בני האדם יחיו באזורים עירוניים. Cities concentrate opportunity and inequality, heat islands, congestion, and service stress—while also hosting innovation capacity.
...
עיור מהיר, כשלים במדיניות קרקע ותחבורה, משילות מקוטעות על פני קצוות המטרו ותשתיות בפיגור בגידול האוכלוסייה.
...
ערימות ערים חכמות ללא פיקוח דמוקרטי הופכות למעקב. העדיפו מוצרים ציבוריים, ניידות והון עצמי בדיור על פני לוחות מחוונים של גאדג'טים.
...
הטמפרטורות העולמיות ומגמות מזג אוויר קיצוניות עולות עם פליטות מצטברות. אנרגיה נקייה מתרחבת במהירות בשווקים רבים, אך מערכות מאובנים, פערי נעילה והתאמה נותרים גדולים.
...
אנרגיה ותעשייה מבוססי מאובנים, שינוי שימושי קרקע ופעולות קולקטיביות מושהות במסגרת תמריצים לרוכבים חופשיים. ההסתגלות אינה ממומנת בחסר יחסית לדיבור הפחתה.
...
המצאות אקלים מקומיות צריכות לצמצם חשיפה אמיתית או פליטות מקומיות - לא לקזז בתיאטרון. תזמון: פרוס חוסן לטווח הקרוב תוך כדי מעברים ארוכים יותר.
...
אינסטינקטים של ריבונות, תמריצים לרוכבים חופשיים, מערכות לא תואמות ואופקים פוליטיים קצרים שחסרים במימון חלקו אזהרה מוקדמת ותגובה מאוחדת.
...
לוח מחוונים משותף ללא קרן משותפת או זכויות החלטה הוא תיאטרון. תכנן ממשל ותמריצים בזהירות כמו החיישנים.
...
אובדן המגוון הביולוגי, כריתת היערות, הידרדרות האוקיינוסים וזיהום נמשכים בשיעורים המאיימים על שירותי המערכת האקולוגית שבני אדם תלויים בהם. אזורים מוגנים ומאמצי שיקום מתרחבים אך מפגרים את גורמי האובדן.
...
המרת בתי גידול, קציר יתר, מינים פולשים, זיהום ושינויי אקלים - מונעים על ידי מערכות כלכליות המחצינות את ערכו של הטבע.
...
המצאות "ירוקות" יכולות לשטוף פרויקטים מיצויים ירוקים. למדוד תוצאות אמיתיות של בית גידול וקהילה. הימנע מלתבוע שחזור מערכת אקולוגית מלאה על לוחות זמנים קצרים של משחק.
...
ההרשמה לבתי ספר עלתה ברחבי העולם, אך תוצרי למידה, מחסור במורים ופערים דיגיטליים משאירים כישרון ענק לא ממומש. משברים ועוני עדיין מושכים ילדים מהכיתות.
...
בתי ספר עם חוסר מימון, איכות ושכר לא אחידים של מורים, חסמי שפה ומוגבלות, פערי קישוריות ועלויות הזדמנות של עבודת ילדים או טיפול בילדים.
...
מורים לבינה מלאכותית ללא מורים יכולים להרחיב פערים אם רק היתרונות הקשורים היטב. העדיפו כלים התומכים במחנכים, בשימוש במצב לא מקוון ובתוכניות לימודים מקומיות - לא פנטזיות חלופות טהורות.
...
עלויות הרחבת רשת גבוהות, שירותים חלשים, עוני ודלקים מלוכלכים או יקרים בשוליים. מדיניות ופיננסים לעתים קרובות מפגרים אפשרות טכנית.
...
הוואטים הראשונים שמתים בשעת בין ערביים נכשלים במרפאות. Pair generation with storage, maintenance training, and realistic load priorities.
...
נורמות חברתיות, לחץ על נישואין, פרנסת מתרגלים, אכיפה חלשה וניידות חוצה גבולות של "חתך העונה". עמדות משתנות במקומות רבים שבהם בנות ונשים שיודעות על FGM אומרות שזה צריך להסתיים, אבל תרגול יכול לפגר את האמונה.
...
העולם מייצר מספיק קלוריות בסך הכל, ובכל זאת רעב ותת תזונה נמשכים עקב עוני, סכסוכים, בזבוז והפצה לקויה. זעזועים במחירים פגעו תחילה במשקי בית עם הכנסה נמוכה.
...
סכסוך זהות, תעמולה דה-הומניזית, מוסדות חלשים, זרימת נשק ורכיבה חופשית בינלאומית. המידע מגיע, אך התמריצים לפעול מוקדם חלשים כאשר העלויות הן מיידיות וההטבות מפוזרות.
...
טכנולוגיה למעקב או מיקוד יכולה לעשות שימוש כפול לכדי דיכוי. תעדוף הגנה אזרחית, מידע מאומת ולגיטימציה קהילתית - לא "ציוני איום" אוטומטיים גרידא. המצאות מקומיות לא צריכות להחליף אחריות פוליטית בהתראות קופסה שחורה.
...
עלויות הדיור עולות על השכר, פערים בבריאות הנפש ובחומרים, הגנות דיירות חלשות ודיור סוציאלי בנוי - בתוספת שחרורים ממוסדות ללא תוכניות דיור.
...
המוכנות למגפה השתפרה בכלים (רצף, פלטפורמות חיסונים) לאחר COVID-19, אך המימון, האמון והשוויון בגישה נותרו שבריריים. מחלות אנדמיות עדיין הורגות מיליונים מדי שנה כאשר המערכות חלשות.
...
זליגה זואונוטית, נסיעות צפופות, טיפול ראשוני חלש, עמידות לאנטי-מיקרוביאלית, מידע מוטעה ומעקב ממומן בחסר באזורים בסיכון גבוה.
...
טכנולוגיה של התפרצות ללא אמון נכשלת. זיהוי צמד עם יכולת תקשורת וטיפול. אל תמציא קופסאות שחורות בהסגר כפוי שהורסות את הלגיטימיות.
...
ניתן למנוע את רוב מקרי המוות של האם באמצעות טיפול מיומן, תחבורה חירום ואספקה ​​בסיסית - אך הפערים נותרים עצומים בין ובתוך מדינות.
...
מרחק למתקנים, מחסור במיילדות ובדם/מוצרים, עוני, הריון בגיל ההתבגרות ופערים באיכות הטיפול כולל יחס לא מכבד המרתיע שימוש.
...
הזיכרון האנושי אינו שלם ואינו אמין אפילו אצל אנשים בריאים. בפעם הראשונה, אנשים רגילים יכולים ליצור רשומות מולטימדיה עשירות של חוויה חיה - אך רוב החיים עדיין לא נלכדים, בלתי ניתנים לחיפוש או נעולים בפורמטים שיירקבו.
...
שכחה ביולוגית; היעדר כלי לכידה פרטיים במחירים נוחים; נטייה ארגונית המוחקת ידע מוסדי; אובדן תרבותי כאשר סיפורי זקנים לעולם אינם מתועדים; התיישנות דיגיטלית של מדיה ופורמטים.
...
זה לא טיפול באלצהיימר או דמנציה. המציא לתיעוד ושימור חוויה - אישית, קהילתית ומוסדית - בהסכמה ופרטיות. רישום חיים ללא שליטה הופך למעקב. העדיפו ארכיונים בבעלות משתמש ומורשת מכובדת, לא אחזור מוחלט כפוי.
...
דיכאון, חרדה ומצבים קשורים הם הגורמים המובילים לנכות ברחבי העולם. הביקוש לטיפול עולה על ההיצע של רופאים; סטיגמה עדיין חוסמת חיפוש עזרה בקהילות רבות.
...
בידוד חברתי, מתח כלכלי, טראומה, שימוש בסמים, שירותים בתת-מימון ומודלים של טיפול שהם ממוקדים בקליניקה ולא משובצים בקהילה.
...
צ'טבוטים אינם מערכת קלינית מלאה. עיצוב עבור נתיבי הסלמה במשבר, פרטיות וטיפול אנושי - לא בידוד באפליקציה שאינה יכולה להתערב בבטחה.
...
המזרח התיכון מחזיק בסכסוכים מרובדים, דינמיקה של כיבוש, טראומה ופרנסה שברירית לצד מאמצי חברה אזרחית, סחר ודיפלומטיה תוססים. אלימות ועקירה חוזרים על עצמם; תהליכי שלום הם לסירוגין ושנויים במחלוקת.
...
תלונות היסטוריות, תחרות גבולות ומשאבים, התערבויות חיצוניות, פוליטיקה סמכותית וסיעתית, והדרה כלכלית שמזינה גיוס וייאוש.
...
המצאות מקומיות צריכות לרכז פרנסה, טיפול מודע לטראומה ותשתיות משותפות - לא "לפתור גיאופוליטיקה" עם גאדג'ט. הימנע מטכנולוגיה חד-צדדית המגבירה מעקב או אסימטריה צבאית תחת תווית שלום.
...
עובדות משותפות ואמון מוסדי נמצאים תחת לחץ מהגברה אלגוריתמית, מדיה סינתטית זולה ועיתונות מקומית חלולה. שקרים נוסעים מהר יותר מתיקונים; משברים (בריאות, בחירות, אסונות) הופכים למצבי חירום אפיסטמיים כמו גם פיזיים.
...
כלכלות תשומת לב מתגמלות זעם; האימות הוא יקר; AI מוזיל את העלות של שכנוע זיופים; קיטוב ואוריינות תקשורתית חלשה שוחקים את הבסיס המשותף; כלי תקשורת באינטרס ציבורי שממומנים בחסר משאירים את השמועה ללא עוררין.
...
מדינות נשק גרעיני מחזיקות בארסנל; המודרניזציה נמשכת; ארכיטקטורת בקרת הנשק מרופדת. הסיכון הוא פחות "ספירה לאחור של הסרט" מאשר חישוב שגוי, תאונה או הסלמה במשבר בזמני החלטה דחוסים.
...
דילמות ביטחוניות, יוקרה, פוליטיקה פנימית של ארסנלים, מערכות התרעה ופיקוד לא מושלמות ושחיקת אמנות ונורמות.
...
המצאה מקומית כמעט אף פעם לא פירושה בניית נשק. התמקדו בחוסן בתקשורת משברים, אוריינות הגנה אזרחית וכלים להורדת הסלמה. אל תזהר מערכות שיגור או תמציא כאילו שחקנים עירוניים שולטים בכפתור הגרעיני.
...
העוני הקיצוני ירד בעולם במשך עשרות שנים אך נותר מרוכז; למאות מיליונים עדיין אין הכנסה אמינים, שירותים וסוכנות. ההתקדמות אינה אחידה; זעזועים (קונפליקט, אקלים, מחלות) הופכים את הרווחים במהירות עבור הפגיעים ביותר.
...
הדרה משווקים ושירותים, זכויות קניין ועובדים חלשות, פערי בריאות וחינוך, בידוד גיאוגרפי, אפליה ופערי קול פוליטי. צמיחה לבדה לא מגיעה לכולם ללא הכללה מכוונת.
...
קיצוניות אלימה והקצנה עדיין מגייסות באמצעות דעות קדומות, צינורות מקוונים ותלונות לא מקוונות. תוכניות מניעה קיימות בבתי ספר ובקהילות, אך הכיסוי אינו אחיד ולעתים קרובות מגיב לאחר פגיעה במקום לנטרל מסלולים מוקדם.
...
קונפליקט זהות, תעמולה דה-הומניזית, הדרה חברתית, שלטון חוק חלש ופלטפורמות שמגבירות תלונות מהר יותר מאשר דיאלוג. צעירים ממוקדים מוקדם - על ספסלי בית הספר ובאינטרנט - לפני אלימות לא מקוונת.
...
פירוק הרדיקליזציה מתחילה בזכויות אדם, בדיאלוג חוצה גבולות, והעצמת בני נוער - לא מעקב המוני או ניבוי "ציוני טרור". Dual-use watchlists can become tools of discrimination. Prefer off-ramps, media literacy, and community legitimacy.
...
עשרות מיליונים נעקרו בכוח. ערים מארחות קולטות כניסות לדיור בלחץ, לבתי ספר ומרפאות. המעמד המשפטי, זכויות העבודה ומסלולי האינטגרציה משתנים מאוד ומשתנים עם הפוליטיקה.
...
סכסוכים, רדיפות, מתח אקלים ומערכות מקלט כושלות. המדינות המקבלות מממנים פחות קליטה בזמן שמשברי מוצא נמשכים.
...
זיהוי ביומטרי ומעקב יכולים להפוך לכלי הדרה. עיצוב לכבוד, גישה לשפה ודיור/עבודה - לא מחסני נתונים ללא הסכמה.
...
בריאות מינית ופורייתית פירושה שאנשים יכולים לנהל חיי מין בטוחים ולהחליט אם, מתי ובאיזו תדירות להתרבות. הגישה לאמצעי מניעה השתפרה בעולם אך נותרה נמוכה באזורים רבים; מחלות מין, טיפולי פוריות ושירותים חסויים לכל המינים בפיגור.
...
מלאי מלאי, סטיגמה, הטיית ספקים, עלויות, מדיניות מגבילה ושירותים המיועדים רק סביב הריון - לא גברים, בני זוג, מתבגרים או טיפולי פוריות. FGM ונישואים בכפייה הם נזקים קשורים אבל לא את כל RH.
...
נושא זה מיועד לכל האנשים - לא רק לנשים ולילדים. טיפול מיילדותי חירום אימהי הוא נושא משלו; FGM הוא נושא משלו. המציא עבור סוכנות, פרטיות, טיפול ב-STI (כולל גברים), בחירה באמצעי מניעה וגישה לפוריות - לעולם אל תכפה בקרת פוריות המוגדרת כטובה.
...
מערכות בינה מלאכותית של Frontier כבר עולות על בני אדם במשימות צרות רבות והן מחוברות לפייסי חיפוש, קוד, פיננסים וטייסים ממשלתיים. "מודיעין-על" מלא לא כאן, אבל הישגים מהירים של יכולת ופריסה תחרותית פירושם שליטה ויישור בפיגור מאחורי היכולת במוסדות רבים.
...
דינמיקת מירוץ מתגמלת מהירות על פני בטיחות; הערכה של מערכות פתוחות היא קשה; תמריצים מעדיפים ייצור; הממשל מפוצל בין מעבדות, מדינות ומערכות אקולוגיות בקוד פתוח; ברגע שמערכות פועלות בקנה מידה, הפוך הוא יקר.
...
המצאות מקומיות שמעבירות החלטות בעלות סיכון גבוה לדגמים אטומים עלולות לנעול נזק לפני שקיימים אמצעי הגנה. העדיפו מסלולי ביקורת והיקפים צרים. אל תמציא כאילו AGI אוטונומית מלאה היא כבר תשתית אמינה.
...
בסדר גודל של מיליארד אנשים כפריים חיים יותר מ-2 ק"מ מכביש כל עונות השנה. בידוד משווקים, מרפאות ובתי ספר הוא תכונת הליבה של מלכודת העוני - "להיות עני זה להיות מבודד". עונות גשומות ושטח חותכים את הגישה עוד יותר.
...
תת השקעה בתשתיות כפריות, תחזוקה חלשה לאחר גזירת סרטים, שטח ואקלים קשים והטיה פוליטית כלפי פרויקטים עירוניים גלויים על פני קישוריות של מייל אחרון.
...
כביש ללא תחזוקה הוא הבטחה זמנית. המציא עבור גישה לכל מזג אוויר, לוגיסטיקה של מרפאות ושוק, ותמריצי תחזוקה - לא רק תיאטרון בנייה חד פעמי. צפו בעקירה ובחטיפת קרקע הממוסגרים כ"פיתוח מסדרון".
...
למיליארדים עדיין אין תברואה המנוהלת בבטחה; למעלה ממיליארד חסרים אפילו שירותים או שירותים פרטיים בסיסיים, ומאות מיליונים מתרגלים עשיית צרכים פתוחים. ביוב עירוני מפגר את הצמיחה הבלתי פורמלית; שירותים של בתי ספר ומערכות בוצה צואה נותרים חוליות חלשות.
...
עלות שירותים וביוב, שירותים תחת מימון, סטיגמה, מחסומי חזקה בקרקע בהתנחלויות בלתי פורמליות, והזנחה של השרשרת המלאה מהשירותים לטיפול בטוח.
...
מדובר בשירותים, ביוב והיגיינה - לא סינון מי שתייה בלבד (ראה מים נקיים). חיישנים ללא ריקון וטיפול הם תיאטרון. העדיפו כבוד, מתקני בית ספר בטוחים מגדרית, וכלכלות בוצה בטוחות על פני הייפ יוקרתי לשירותים חכמים למי שכבר שרת.
...
משקי בית וקהילות בלחץ עדיין מחסלים נכסים ארוכי טווח להישרדות מיידית: חקלאים שוחטים פרות חולבות ברעב; יערות נשרפו עבור שדה העונה. אותו דפוס מופיע בפוליטיקה ובפירמות שפושטות על העתיד לתשואות קצרות.
...
מלכודות עוני ורשתות ביטחון חסרות מאלצות שיעורי הנחה גבוהים; זכויות קרקע ומשאבים חסרי ביטחון; שווקים ופוליטיקה שמתגמלים את התשואה של הרבעון הזה על פני עשרות שנים של הון אדמה, יער וחוסן.
...
קשור לעוני, אבל הבעיה המרכזית היא פשרה זמנית. המציאו תמריצים וחוצצים שהופכים את ההגנה על המחר לרציונלית היום - לא הרצאות שמתעלמות מבטן ריקה. הימנעו מתכניות "ירקות" שנועלות את העניים מפרנסות ללא חלופות.
...
עבדות מטלטל היא בלתי חוקית כמעט בכל מקום, אבל עבודת כפייה, שעבוד חובות, סחר ועבודת ילדים נמשכים בשרשרת האספקה, בעבודות הבית, בדיג ובאזורי סכסוך - לעתים קרובות מוסתרים מצרכנים.
...
הרווח מכוח עבודה זול בכפייה, אכיפה חלשה, פגיעות הגירה, שחיתות ושרשרות אספקה ​​מרובות שכבות אטומות שמדללות את האחריות.
...
מעקב עובדים המשווק כ"ציות" עלול לפגוע באנשים שאתה טוען שהם מגנים עליהם. עצב עם קול עובד, דיווח בטוח ותיקון - לא רק הוכחות בלוקצ'יין למותגים.
...
יותר ממיליארד אנשים עדיין משתמשים בטבק באופן קבוע; עישון הורג מיליונים מדי שנה ונשאר מרוכז במדינות בעלות הכנסה נמוכה גם כאשר שיעורי ההכנסה הגבוהים יורדים. עישון פסיבי וספיגת ניקוטין לנוער (כולל מוצרים חדשים) שומרים על המגיפה בחיים.
...
ביולוגיה של התמכרות, שיווק בתעשייה, צפיפות קמעונאית, שירותי הפסקה חלשים ורגולציה מפגרת שבה האכיפה דלילה. נורמות חברתיות ומתח שומרים על החניכה גבוהה בקרב בני נוער במקומות מסוימים.
...
קמפיינים של בושה בלבד מכשילים אנשים עם הכי פחות גישה להפסקה. המציא למניעת התחלות, תמיכת גמילה במחיר סביר והגנה מיד שנייה - לא מעקב אחר מעשנים ללא טיפול. הימנע מ"פתרונות" של לכידת התעשייה.
...
כוח כפייה מרוכז, מונופולים בתקשורת הממלכתיים, תשתיות צנזורה, פחד מהתאגדות ורכיבה חופשית בינלאומית כאשר לא ניתן להגיע בבטחה לאוכלוסיות מבודדות.
...
ערים מייצרות בסדר גודל של שני מיליארד טונות של פסולת עירונית מוצקה מדי שנה, בתוספת פסולת אלקטרונית ענקית וזרמים מסוכנים. מערכות מיחזור ומעגליות צומחות אך מפגרות בייצור; מזבלות, מזבלות פתוחות וניקוז סתומים מפלסטיק עדיין שולטים במקומות רבים.
...
ייצור ליניארי, אריזות חד פעמיות זולות, איסוף חלש, הדרה של המגזר הבלתי פורמלי מתוכניות רשמיות וסחר עולמי בפסולת שמעביר את הפגיעה לאזורים עניים יותר.
...
אל תמציא "לייצא את האשפה" כהצלחה מקומית. עיצוב עם פרנסה של קוטפים לא רשמיים, התאוששות חומר אמיתית והפחתה במקור. שריפת פסולת אלקטרונית ושיטפונות חנוקים מפלסטיק זקוקים למערכות, לא ניקוי חופים חד פעמי כמו המציאה כולה.
...
למיליארדים עדיין אין מי שתייה או תברואה המנוהלים בבטחה. מתח אקלים, זיהום וחילוץ יתר פוגעים בבארות ובשירותים; כלכלות מכליות ממלאות פערים בעלות גבוהה.
...
תת השקעה בתשתיות, זיהום, דלדול אקוויפר, ממשל חלש של מים משותפים ועוני שמתמחר את משקי הבית מחוץ לאספקה ​​בטוחה.
...
משאבות ללא תקציבי תחזוקה נכשלות. עיצוב לתיקון מקומי, אנרגיה לטיפול והקצאה הוגנת - לא נפילות חומרה חד-פעמית.
...
גלי חום, שיטפונות, סערות ובצורת שכיחים או חזקים יותר באזורים רבים תחת שינויי אקלים. האזהרה המוקדמת השתפרה, אבל התראות המייל האחרון, התשתיות וקרנות ההבראה עדיין מכשילות את המחוזות העניים ביותר.
...
אווירה חמה יותר ואוקיינוסים מעמיסים את הקוביות לקיצוניות; החשיפה גדלה עם התרחבות החוף והעירונית; תת השקעה בתשתיות עמידות וברשתות ביטחון חברתיות.
...
חיישנים ללא תוכניות תגובה הם תיאטרון. המציא עבור לולאות אזהרה לפעולה, מקלט קירור/הצפה והון עצמי - לא רק לוחות מחוונים יפים יותר. העיתוי משנה: פרסו פיילוטים שמישים לפני העונה הבאה, לא דגמים מושלמים אחרי.
...
השוויון המשפטי התקדם במדינות רבות, אך נותרו פערים בבטיחות, בשכר, בכוח הפוליטי, בגישה לחינוך ובזכויות הרבייה. תגובה נגדית ואכיפה לא אחידה הופכת רווחים במקומות מסוימים.
...
נורמות פטריארכליות, תלות כלכלית, אלימות וחסמים משפטיים, תת ייצוג במוסדות ותת השקעה בתשתיות טיפול הנופלות באופן לא פרופורציונלי על נשים.
...
טכנולוגיה שמתעלמת מבטיחות (למשל, שיתוף מיקום ציבורי ללא בקרות) עלולה להגביר את הנזק. סוכנות מרכז, פרטיות ומנהיגות של נשים מקומיות - לא גאדג'טים של מושיע שתוכננו במקום אחר.
...
רק כ-35% מתלמידי STEM בהשכלה גבוהה בעולם הן נשים. בנות לרוב מתפקדות טוב בשלב מוקדם, ואז עוזבות מסלולי מתמטיקה ומדעים במעברים משניים ושלישוניים; שימור מקום העבודה במעבדות ובתפקידים טכנולוגיים נותר לא שוויוני.
...
סטריאוטיפים, בתי ספר לא בטוחים או מרוחקים, עבודה במשק בית, תרבויות מעבדה עוינות, מנטורים ומודלים לחיקוי חסרים ותשתית טיפול שנופלת על נשים לאחר תארים. זו בעיית צינור STEM - לא כל שוויון הזכויות.
...
אל תמציא "אפליקציה אחת מעוררת השראה" בתור הפתרון כולו. העדיפו מעבר בטוח, תרבות מעבדה, מלגות עם השמה וטיפול בקרבת מקומות עבודה. להבדיל מהמצאות כלליות של זכויות נשים (בטיחות, חוק, קול פוליטי) - שמור על התמקדות במסלולי מדע והנדסה.
