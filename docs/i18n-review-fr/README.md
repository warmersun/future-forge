# French translation review pack

Side-by-side **English / French** strings for review and correction.

| File | Contents | Entries (approx) |
|------|----------|------------------|
| [01-ui.md](./01-ui.md) | UI chrome (`locales/fr/ui.json`) | 852 |
...
2. Change only text after **`FR:`** (or the FR block for long strings).
...
> Apply my corrections from `docs/i18n-review-fr/`
...
- Regenerate this pack: `node scripts/i18n-export-review-md.mjs --locale fr`
